...
class TextModel:
    ...
    def train_model(self):
        ...
        self.history = self.model.fit(self.X_train_pad, self.y_train_cat, batch_size=self.hyperparameters["batch_size"], epochs=self.hyperparameters["epochs"], validation_split=self.hyperparameters["validation_split"])
