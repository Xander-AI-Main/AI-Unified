...
architecture = {} # from json file
hyperparameters = {} # from json file
dataset_url = "https://idesign-quotation.s3.ap-south-1.amazonaws.com/NO_COMPANYNAME/data_new.json"
bot = QABot(dataset_url, False, 'chatbot', 'DL', 'default', architecture, hyperparameters)
question_embeddings, answer_embeddings = bot.encode_embeddings()
